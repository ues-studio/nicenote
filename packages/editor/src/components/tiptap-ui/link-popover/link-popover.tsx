  ...
  ({ className, children, ...props }, ref) => {
    return (
      <Button
        type="button"
        data-style="ghost"
        data-active-state={props['aria-pressed'] ? 'on' : 'off'}
        role="button"
        tabIndex={-1}
        ref={ref}
        {...props}
        className={className}
      >
        {children || <Link className={cn('w-4 h-4 shrink-0', 'tiptap-button-icon')} />}
      </Button>
    )
  }
)
      ...
      >
        <CardItemGroup orientation="horizontal">
          ...
          <ButtonGroup orientation="horizontal">
            ...
            >
              <CornerDownLeft className={cn('w-4 h-4 shrink-0', 'tiptap-button-icon')} />
            </Button>
          </ButtonGroup>
          ...
          <ButtonGroup orientation="horizontal">
            <Button
              ...
              data-style="ghost"
            >
              <ExternalLink className={cn('w-4 h-4 shrink-0', 'tiptap-button-icon')} />
            </Button>
            ...
            <Button
              ...
              data-style="ghost"
            >
              <Trash2 className={cn('w-4 h-4 shrink-0', 'tiptap-button-icon')} />
            </Button>
          </ButtonGroup>
        </CardItemGroup>
      </CardBody>
      ...
      <Popover open={isOpen} onOpenChange={handleOnOpenChange}>
        <PopoverTrigger asChild>
          <LinkButton
            ...
            ref={ref}
          >
            {children ?? <Icon className={cn('w-4 h-4 shrink-0', 'tiptap-button-icon')} />}
          </LinkButton>
        </PopoverTrigger>
